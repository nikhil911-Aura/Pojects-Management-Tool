        ...
        <div className="px-8 py-8 border-b border-asana-border flex items-center space-x-6">
          <div className="relative flex-shrink-0 group/avatar">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 w-7 h-7 rounded-full bg-[var(--asana-surface)] border-2 border-[var(--asana-border)] flex items-center justify-center shadow hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors disabled:cursor-wait"
              title="Change profile picture"
            >
              {uploadingAvatar ? (
                <svg className="w-3.5 h-3.5 text-[var(--asana-text-primary)] animate-spin" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z" />
                </svg>
              ) : (
                <svg className="w-3.5 h-3.5 text-[var(--asana-text-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="min-w-0">
            ...
            <button
              type="button"
              onClick={handleAvatarClick}
              className="mt-2 text-xs text-[var(--asana-blue)] hover:underline"
            >
              Change photo
            </button>
          </div>
